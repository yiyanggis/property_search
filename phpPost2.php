...
//$form_url = "http://www.vrbo.com/api/vacation-rentals?brand=vrbo&location=usa%2Fcalifornia%2Fsan-diego-county%2Fcarlsbad&datesFirm=1&currency=USD&pagingInfo=10";
$form_url="http://www.vrbo.com/api/vacation-rentals?brand=vrbo&location=usa%2Fcalifornia%2Forange-county%2Fhuntington-beach&datesFirm=1&currency=USD&pagingInfo=5";
...
foreach ($result_records->listings as &$value) {
    ...
    $sql="update ".$tablename." set listnum='".$value->listingNumber."' where id=".$value->unitId;
